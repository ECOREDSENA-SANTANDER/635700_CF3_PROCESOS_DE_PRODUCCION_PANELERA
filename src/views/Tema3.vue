...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure(data-aos="zoom-in")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/ji3Mmw6Jzbg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    p.mb-5(data-aos="fade-right") Según el Instituto Nacional de Vigilancia de Medicamentos y Alimentos (Invima), las Buenas Prácticas de Manufactura son los requerimientos generales de higiene en la manipulación, preparación, envasado, almacenamiento, transporte y distribución de alimentos para consumo humano, con el objeto de garantizar la calidad de los mismos en cada una de las operaciones mencionadas, velando por que cumplan con las condiciones sanitarias adecuadas, y disminuyendo los riesgos inherentes a la producción. El Invima es una de las autoridades sanitarias encargadas de vigilar estas prácticas BPM y emitir conceptos sanitarios frente a las mismas.
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-5(data-aos="fade-right")
        ...
        p Para profundizar en el estudio de las Buenas Prácticas de Manufactura, le invitamos a observar el siguiente video:

        p #[strong “Buenas Prácticas de Manufactura Trapiche panelero”]

        a.anexo.mb-4(href="https://www.youtube.com/watch?v=iuW5c9LgQys" target="_blank")
          .anexo__icono
            img(src="@/assets/curso/temas/tema3/icono-link.svg")
          .anexo__texto
            p #[strong Fedepanela. (2019),] Buenas Prácticas de Manufactura Trapiche Panelero
    ...
    .BGIMG01.p-4.mb-5(data-aos="fade-right")
      SlyderA(tipo='b')
        .row.justify-content-around.align-items-center.my-3
          .col-md-6.mb-4.mb-md-0
            h4 Resolución 779 de 2006
            p Por la cual se establece el reglamento técnico sobre los requisitos sanitarios que se deben cumplir en la producción y comercialización de la panela para consumo humano y se dictan otras disposiciones.
        ...
        .row.justify-content-around.align-items-start.my-3
          .col-md-6.mb-4.mb-md-0
            h4 Requisitos de calidad de la panela
            p Que la panela es un producto con un importante valor nutricional, de alto consumo especialmente en la dieta de la población infantil.
          .col-md-5
            figure
              img(data-aos='fade-left')(src='@/assets/curso/temas/tema3/img3-4.svg', alt='Requisitos fisicoquímicos')
              figcaption Nota. Tomado de Ministerio de la Protección social (2016).
        ...
        .row.justify-content-around.align-items-center
          ...
          .col-auto
            figure
              img(data-aos='fade-left')(src='@/assets/curso/temas/tema3/img3-5.svg', alt='Mazo')
    ...
    .d-flex.flex-wrap.justify-content-center.justify-content-md-around
        ...
        .tarjeta.tarjeta-flip.bgGreen(@mouseover="indicadorTarjetaFlip = false").my-3
        ...
        .tarjeta.tarjeta-flip.bgGreen(@mouseover="indicadorTarjetaFlip2 = false").my-3
          .indicador--hover(v-if="indicadorTarjetaFlip2")
          .tarjeta-flip__contenedor
            .tarjeta-flip__img(:style="{'background-image': `url(${require('@/assets/curso/temas/tema3/img3-10.svg')})`}")
            .tarjeta-flip__contenido.px-4.px-xl-5
...
<style lang="sass">
.tarjeta-flip.bgGreen
  width: 400px
  height: 346px
.tarjeta-flip.bgGreen .tarjeta-flip__contenido
  background: #81AF1D
  display: flex
  align-items: center
